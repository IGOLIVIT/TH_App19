...
class CoreDataStack {
    ...
    func deleteQuote(withQQuote name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<QuotesModel> = QuotesModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "qQuote == %@", name)
